...
def trf_analysis_normalized(epochs, random_epochs, freqs=np.arange(1, 40, 1), epoch_type='pre_tic'):
    ...
    # ------------------------------------------------------------------ #
    # Step 1: compute baseline mean/std from random epochs                #
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # Step 2: compute TFR on epochs, normalize per epoch then average     #
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # Step 3: put data back into MNE object to keep metadata              #
    # ------------------------------------------------------------------ #
...
# =============================================================================
# Function: Time-Frequency analysis for each ROI (normalized)
# =============================================================================
def tfr_per_ROI_normalized(patient, pre_tic_epochs, random_epochs, epoch_type='pre_tic', freqs=np.arange(1.0, 40.0, 2.0), bad_channels=[]):
    """
    ...
    power = power.crop(tmin=-1.0, tmax=0.3)
...
# =============================================================================
# Function: Plot TFR for each ROI
# =============================================================================
